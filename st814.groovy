 ...
 *
 * lgk add support for primary control so temp shows up on new mobile app 8/2020
 */
metadata 
{
	definition (name: "EverSpring ST814 V4b", namespace: "lgkapps",  author: "@Ben chad@monroe.io and lgkahn", ocfDeviceType: "x.com.st.d.sensor.moisture", mnmn: "SmartThingsCommunity", vid: "97ba8873-f610-3322-a2be-ec1650316228" )
	{
		capability "Battery"
...
def installed() {
    ...
    // use settings report time for check interval it is mintes
    	sendEvent(name: "checkInterval", value: $settings.ReportTime * 60 , displayed: false, data: [protocol: "zwave", hubHardwareId: device.hub.hardwareID])
